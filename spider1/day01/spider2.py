...
class SpiderTieba(object):
    ...
    def __init__(self,sp_name='美女'): # 　去想要爬取的网站上寻找相关规律
        self.sp_name = sp_name
        # 模拟浏览器批量访问网站
        # 寻找ｕｒｌ规律
        temp1_url = 'http://www.mm131.com/xinggan/list_6_{}.html'
        temp_url = 'http://soso.nipic.com/?q='+self.sp_name+'&page={}'
        # 模拟浏览器设置
        ...
        for i in range(0,5):
            ...
            print(temp_url)
            self.url_list.append(temp1_url.format(i))
            print(temp1_url)
        print(self.url_list)
    ...
    def save_html(self,html,page_num):
        ...
        file_path1 = '/home/python/Desktop/'+str(page_num)+'.html'
